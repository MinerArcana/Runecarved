...
public class GuiSimpleEnchanter extends GuiContainer {
	...
	private final ContainerSimpleEnchanter container;
	public int ticks;
	public float flip;
	public float oFlip;
	public float flipT;
	...
	public GuiSimpleEnchanter(InventoryPlayer inventory, World worldIn, TileEntitySimpleEnchanter tile) {
		super(new ContainerSimpleEnchanter(inventory, worldIn, null, tile));
		this.playerInventory = inventory;
		this.container = (ContainerSimpleEnchanter) this.inventorySlots;
	}
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		for(int l = 0; l < 3; ++l) {
			...
			if(k1 == 0) {
				...
				if(((this.mc.player.experienceLevel < k1) && !this.mc.player.capabilities.isCreativeMode)
						|| this.container.enchantClue[l] == -1) // Forge: render buttons as disabled when enchantable
